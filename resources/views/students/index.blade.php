                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex justify-center">
                                            ...
                                            <button type="button" onclick="confirmDelete('{{ $student->id }}')" class="bg-pink-400 dark:bg-pink-600 hover:bg-pink-500 dark:hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">Borrar</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
